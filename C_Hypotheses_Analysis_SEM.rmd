...
# Function to handle missing data according to replication protocol
```{r}
Rep_exclusion_criteria <-function(df_adjr){
...
```{r}
clean_data_2 <- Rep_exclusion_criteria(df_adjr) # cleaned data based on replication protocol
```

# Data summary based on replication protocol's exclusion criteria
```{r}
