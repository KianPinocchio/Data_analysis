...
write.csv(scored_data, "scored_data_imputed.csv", row.names = FALSE) # Save scored data in a csv file
```
...
parameterEstimates(Mod.Med.SEM, remove.nonfree = TRUE, 
                   standardize = TRUE, ci = TRUE, 
                   boot.ci.type = "perc",
                   pvalue = TRUE, output = "pretty")
```
...
# Paths plot: C1, Imputed Y ~ sum_neg
```{r}
# Plot model
