...
data_simulation_function = function(N_total, 
  ...
  #error
  error = rnorm(n = N_total, m = 0, sd = error_sd)
...
#   simulations
error_deviation_simulation_function = function(N_total, 
                                               CRA_coefficient,
                                               SES_coefficient,
                                               PSS_coefficient,
                                               int_coefficient,
...
all_outcome_observations_SD = error_deviation_simulation_function(N_total = 301,
